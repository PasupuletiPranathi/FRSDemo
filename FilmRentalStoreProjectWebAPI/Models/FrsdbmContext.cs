...
public partial class FrsdbmContext : DbContext
{
    public FrsdbmContext()
    {
    }

    public FrsdbmContext(DbContextOptions<FrsdbmContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=INBLRVM26590142;Database=FRSDBM;Integrated Security=true; TrustServerCertificate=yes");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Actor>(entity =>
        {
            entity.HasKey(e => e.ActorId)
                .HasName("PK__actor__8B2447B53376EEA0")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.AddressId)
                .HasName("PK__address__CAA247C9E9FB0897")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId)
                .HasName("PK__category__D54EE9B5BF9D19BB")
                .IsClustered(false);
        ...
        modelBuilder.Entity<City>(entity =>
        {
            entity.HasKey(e => e.CityId)
                .HasName("PK__city__031491A94DDBC1B5")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Country>(entity =>
        {
            entity.HasKey(e => e.CountryId)
                .HasName("PK__country__7E8CD0545D023BDC")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId)
                .HasName("PK__customer__CD65CB8488A949E7")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Film>(entity =>
        {
            entity.HasKey(e => e.FilmId)
                .HasName("PK__film__349764A8D579B4BB")
                .IsClustered(false);
        ...
        modelBuilder.Entity<FilmActor>(entity =>
        {
            entity.HasKey(e => new { e.ActorId, e.FilmId })
                .HasName("PK__film_act__086D31FF9C628F6F")
                .IsClustered(false);
        ...
        modelBuilder.Entity<FilmCategory>(entity =>
        {
            entity.HasKey(e => new { e.FilmId, e.CategoryId })
                .HasName("PK__film_cat__69C38A336A134793")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => e.FilmId)
                .HasName("PK__film_tex__349764A801B47CB2")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Inventory>(entity =>
        {
            entity.HasKey(e => e.InventoryId)
                .HasName("PK__inventor__B59ACC486D2FAAAC")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Language>(entity =>
        {
            entity.HasKey(e => e.LanguageId)
                .HasName("PK__language__804CF6B2C351D71D")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            entity.HasKey(e => e.PaymentId)
                .HasName("PK__payment__ED1FC9EB7109DA5B")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Rental>(entity =>
        {
            entity.HasKey(e => e.RentalId)
                .HasName("PK__rental__67DB611A20CBB764")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__D80AB4BB2CE4DC34");
        ...
        modelBuilder.Entity<Staff>(entity =>
        {
            entity.HasKey(e => e.StaffId)
                .HasName("PK__staff__1963DD9DC0E3D996")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Store>(entity =>
        {
            entity.HasKey(e => e.StoreId)
                .HasName("PK__store__A2F2A30DE9C04B71")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__usertabl__B9BE370F965C78A5");
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Usertables)
                ...
                .HasConstraintName("FK__usertable__Role___02084FDA");
        });
